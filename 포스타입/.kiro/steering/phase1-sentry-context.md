...
```
:clipboard: Phase 1 완료 — Sentry 컨텍스트 수집 결과
...
- :link: 링크: <issueUrl>
- :label: 에러 타입: <title>
- :bar_chart: 발생 횟수: <count>회
- :busts_in_silhouette: 영향 사용자: <userCount>명
- :clock1: 최초 발생: <firstSeen>
- :clock1: 최근 발생: <lastSeen>
